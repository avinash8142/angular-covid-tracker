    ...
    this.pieChartIndia = new Chart('canvasIndiaDistrict', {
        ...
        data: {
          ...
          datasets: [{
            ...
            borderColor: '#3cba9f',
            backgroundColor: ['#8B0000','#FF7F50', '#008080','#FFA500','#239B56', '#1F618D', '#148F77', '#1E8449', '#B7950B', '#DC7633', '#A04000',"#3cb371",  
                              '#0000FF','#FF7F50','#FF8C00','#FFA500','#9ACD32',,"#3cb371", "#9966FF", '#ADFF2F', '#32CD32','#239B56', '#008000', 
                              '#4C4CFF', "#00FFFF", "#f990a7", "#aad2ed", "#FF00FF", '#0000FF', '#9966FF', '#4C4CFF', '#f990a7', '#FF00FF'],
            // backgroundColor:['#8B0000','#B22222','#DC143C', '#DC143C','#FF0000', '#FF4500', '#FF6347', '#DB7093', 
            //                  '#FF7F50','#FF8C00','#FFA500','#9ACD32', '#ADFF2F', '#32CD32','#239B56', '#008000', 
            //                  '#1F618D', '#148F77', '#1E8449', '#B7950B', '#DC7633',"#3cb371",'#008080',
            //                  '#0000FF', '#9966FF', '#4C4CFF', '#f990a7', '#FF00FF'],
            fill:true,
          }]
        },
        options: {
